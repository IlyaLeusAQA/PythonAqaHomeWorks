...
from core.contracts import PARTIAL_UPDATE_USER_SCHEME
import allure

BASE_URL = "https://reqres.in/api/users/2"


@allure.suite('Частичное обновление тестового юзера')
...
def test_partial_update_user_data_only_name():
    ...
    with allure.step(f'Получаем структуру объекта с id: {BASE_URL[-1]}'):
        validate(response_json, PARTIAL_UPDATE_USER_SCHEME)
